...
const radio = {
    ...
    "fenomenfm": "http://fenomenoriental.listenfenomen.com/fenomenoriental/128/icecast.audio",
      ...
      if (!args) return msg.channel.send('❎ | Bir **radyo seçin:** **fenomenfm** | **powerturk** | **powerturk** | **metrofm** | **fenomen** | **oyunfm** | Örnek kullanım : **C!radyo fenomen**')
  ...
  if (msg.content.startsWith('C!kapat')) {
