...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .addField('Sunucu burada tanıtıldı! (https://discord.gg/aAZyvsB).')
  .addField('12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
  .addField('Sunucunu tanıtabilmek için beni ekle! https://bit.ly/2Tu3rPb')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.get('560540582229835786').send(embed)
            });
